...
# DATA_PATH = '/home/houzeyu2683/Downloads/Projects/lab/resource/acne04-origin/ACNE04/Classification/JPEGImages'
DATA_PATH = '/home/houzeyu2683/Desktop/Projects/lab/resource/acne04-default/jpg/'
...
def trainval_test(cross_val_index, sigma, lam):
    ...
    # TRAIN_FILE = '/home/houzeyu2683/Downloads/Projects/lab/resource/acne04-origin/ACNE04/Classification/NNEW_trainval_' + cross_val_index + '.txt'
    # TEST_FILE  = '/home/houzeyu2683/Downloads/Projects/lab/resource/acne04-origin/ACNE04/Classification/NNEW_test_' + cross_val_index + '.txt'
    TRAIN_FILE = '/home/houzeyu2683/Desktop/Projects/lab/resource/acne04-default/NNEW_trainval_' + cross_val_index + '.txt'
    TEST_FILE  = '/home/houzeyu2683/Desktop/Projects/lab/resource/acne04-default/NNEW_test_' + cross_val_index + '.txt'
    ...
    for epoch in range(lr_steps[-1]):#(EPOCH):#
        ...
        for step, (b_x, b_y, b_l) in enumerate(train_loader):   # gives batch data, normalize x when iterate train_loader
            ...
            ##  Start forward and compute the loss from the loss function.
...
cross_val_lists = ['0', '1', '2', '3', '4']
cross_val_index = cross_val_lists[0]
sigma=30 * 0.1
lam=6 * 0.1
...
image, label, lesion = batch
cnn = resnet50()
cls, cou, cou2cls = cnn.forward(x=image, x_new=None)
print(cls.shape)
print(cou.shape)
print(cou2cls.shape)

##
b_x, b_y, b_l = next(iter(train_loader))

## generating ld
b_l = b_l - 1
ld = genLD(b_l, sigma, 'klloss', 65)  ##  The max of lesion count of image: 64
ld_4 = np.vstack(
    (
        np.sum(ld[:, :5], 1), 
        np.sum(ld[:, 5:20], 1), 
